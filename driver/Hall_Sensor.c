...
// 消抖总次数
#define HALL_SENSOR_DISAPPERAS_SHAKS_COUNT 50
/*********************内部变量************************/
static int16_t Hall_Sensor_DisapperasShakes_IdleCount = 0;    // 消抖时的空闲状态计数值
static int16_t Hall_Sensor_DisapperasShakes_TriggerCount = 0; // 消抖时的触发状态计数值
