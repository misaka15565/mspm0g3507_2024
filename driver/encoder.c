...
int32_t encoderA_get() { return Get_Encoder_countA; }
int32_t encoderB_get() { return Get_Encoder_countB; }
void encoderA_clear() { Get_Encoder_countA = 0; }
void encoderB_clear() { Get_Encoder_countB = 0; }